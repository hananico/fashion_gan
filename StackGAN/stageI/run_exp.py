...
import sys
sys.path.append("/home/roozbeh/eccv/codes/StackGAN/")
#from misc import *

#from misc.datasets import TextDataset
#import importlib.util
#spec = importlib.util.spec_from_file_location("misc.datasets", "~/eccv/codes/StackGAN/misc.datasets")
import imp

foo = imp.load_source("misc.datasets", "/home/roozbeh/eccv/codes/StackGAN/misc/datasets.py")
...
if __name__ == "__main__":
    ...
    dataset = foo.TextDataset(datadir, cfg.EMBEDDING_TYPE, 1)
